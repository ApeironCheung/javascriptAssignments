...
function p02Func() {
   ...
   document.getElementById("flowchart").setAttribute("src","images/volleyball/volleyball_design.jpg");
   document.getElementById("flowchart").setAttribute("display","none");
   document.getElementById("js").setAttribute("src","images/volleyball/volleyball_js.jpg");
   document.getElementById("js").setAttribute("display","none");
   document.getElementById("another").setAttribute("src","images/volleyball/volleyball_another.png");
   document.getElementById("another").setAttribute("display","none");
 }
